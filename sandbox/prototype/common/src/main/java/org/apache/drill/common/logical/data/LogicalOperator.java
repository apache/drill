...
public interface LogicalOperator extends Iterable<LogicalOperator>{
	...
	public static final Class<?>[] SUB_TYPES = {Write.class, Aggregate.class, Group.class, Filter.class, Flatten.class, Join.class, Order.class, Limit.class, Project.class, Scan.class, Sequence.class, Transform.class, Union.class, WindowFrame.class};
