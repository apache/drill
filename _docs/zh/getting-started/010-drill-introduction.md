...
* [十分钟教程]({{ site.baseurl }}/docs/drill-in-10-minutes/)
* [查询 文件]({{ site.baseurl }}/docs/querying-a-file-system)
* [查询 HBase]({{ site.baseurl }}/docs/querying-hbase)
* [SQL语法]({{ site.baseurl }}/docs/sql-reference-introduction/)
* [快速指南]({{ site.baseurl }}/docs/tutorials-introduction)

## Apache Drill 1.19 新特性
* <a href='https://issues.apache.org/jira/browse/DRILL-92'>DRILL-92</a> - 增加 Cassandra 数据源
* <a href='https://issues.apache.org/jira/browse/DRILL-3637'>DRILL-3637</a> - 增加 ElasticSearch 数据源
* <a href='https://issues.apache.org/jira/browse/DRILL-7823'>DRILL-7823</a> - 增加 XML 数据源
* <a href='https://issues.apache.org/jira/browse/DRILL-7751'>DRILL-7751</a> - 增加 Splunk 数据源
* <a href='https://issues.apache.org/jira/browse/DRILL-5940'>DRILL-5940</a> - Kafka 数据源支持 Schema Registry
* <a href='https://issues.apache.org/jira/browse/DRILL-7855'>DRILL-7855</a> - 支持 Vault 安全模块集成
* <a href='https://issues.apache.org/jira/browse/DRILL-7921'>DRILL-7921</a> - 支持 ARM-based 硬件
* <a href='https://issues.apache.org/jira/browse/DRILL-6953'>DRILL-6953</a> - 基于行集框架的 JSON 通用读取器
* <a href='https://issues.apache.org/jira/browse/DRILL-7733'>DRILL-7733</a> - 支持 RESTful 流式查询
* 基于 Enhanced Vector Framework（EVF）重构了多个数据源：
  * <a href='https://issues.apache.org/jira/browse/DRILL-7525'>DRILL-7525</a> - SequenceFiles 数据源
  * <a href='https://issues.apache.org/jira/browse/DRILL-7532'>DRILL-7532</a> - SysLog 数据源
  * <a href='https://issues.apache.org/jira/browse/DRILL-7533'>DRILL-7533</a> - Pcap-NG 数据源
  * <a href='https://issues.apache.org/jira/browse/DRILL-7534'>DRILL-7534</a> - HTTPD 数据源
  * <a href='https://issues.apache.org/jira/browse/DRILL-7536'>DRILL-7533</a> - Image 数据源
