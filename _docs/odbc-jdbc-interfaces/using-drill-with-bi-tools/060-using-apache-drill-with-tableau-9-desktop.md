...
slug: "Using Apache Drill with Tableau 9 Desktop"
...
1. Click **Start**, and locate the Install Tableau TDC File app that the MapR Drill ODBC Driver installer installed.   
   ...
   ![]({{ site.baseurl }}/images/docs/odbc-mapr-drill-apps.png)
...
1.	In a Tableau Workbook click **Data > New Data Source**.![drill query flow]({{ site.baseurl }}/images/docs/new-data-source.png)
2.	In the **Connect** list, select **Other Databases (ODBC)**. ![drill query flow]({{ site.baseurl }}/images/docs/connect-list.png)
...
![drill query flow]({{ site.baseurl }}/images/docs/other-dbs.png) ![drill query flow]({{ site.baseurl }}/images/docs/other-dbs-2.png)
Tableau is now connected to Drill, and you can select various tables and views. ![drill query flow]({{ site.baseurl }}/images/docs/tableau-schemas.png)
...
For example: ![drill query flow]({{ site.baseurl }}/images/docs/edit-custom-sql.png)

2.	Next select the Hive products table: ![drill query flow]({{ site.baseurl }}/images/docs/custom-sql-query.png)

3.	Verify that Tableau is joining the two data sources (JSON files and Hive table) on the prod_id key:![drill query flow]({{ site.baseurl }}/images/docs/tableau-join-key.png)
...
8.	Add a grand total row by clicking **Analysis > Totals > Show Column Grand Totals**. ![drill query flow]({{ site.baseurl }}/images/docs/tableau-desktop-query.png)
