...
{% include startnote.html %}The MapR ODBC/JDBC drivers for Drill 1.14 are not yet available, but should be available by the end of August. Earlier versions of the drivers do not work with Apache Drill 1.14.{% include endnote.html %}        
