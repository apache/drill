...
---
## Handling HBase Data
To query HBase data in Drill, convert every column of an HBase table to/from byte arrays from/to an SQL data type using [CONVERT_TO or CONVERT_FROM]({{ site.baseurl }}/docs//data-type-conversion/#convert_to-and-convert_from) except INT and BIGINT. Use [CAST]({{ site.baseurl }}/docs/data-type-conversion/#cast) to convert integers to/from HBase.
