...
public interface Filterer {
  ...
  void setup(FragmentContext context, RecordBatch incoming, RecordBatch outgoing, TransferPair[] transfers, SkippingRecordLogger skipRecordLogging) throws SchemaChangeException;
  void filterBatch(int recordCount);
