 ...
 *
 * Syntax:
 * CREATE [OR REPLACE] MATERIALIZED VIEW [IF NOT EXISTS] view_name [(field1, field2 ...)] AS select_statement
 */
public class SqlCreateMaterializedView extends DrillSqlCall {

  public static final SqlSpecialOperator OPERATOR = new SqlSpecialOperator("CREATE_MATERIALIZED_VIEW", SqlKind.OTHER_DDL) {
    @Override
    public SqlCall createCall(SqlLiteral functionQualifier, SqlParserPos pos, SqlNode... operands) {
      return new SqlCreateMaterializedView(pos, (SqlIdentifier) operands[0], (SqlNodeList) operands[1],
          operands[2], (SqlLiteral) operands[3]);
    }
  };
  ...
  public SqlCreateMaterializedView(SqlParserPos pos, SqlIdentifier viewName, SqlNodeList fieldList,
  ...
  public AbstractSqlHandler getSqlHandler(SqlHandlerConfig config) {
    return new MaterializedViewHandler.CreateMaterializedView(config);
  }
