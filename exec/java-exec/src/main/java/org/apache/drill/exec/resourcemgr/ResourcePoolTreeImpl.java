...
import static org.apache.drill.exec.resourcemgr.RMCommonDefaults.ROOT_POOL_DEFAULT_MEMORY_PERCENT;
...
public class ResourcePoolTreeImpl implements ResourcePoolTree {
    ...
    try {
      ...
      this.selectionPolicy = QueueSelectionPolicyFactory.createSelectionPolicy(
        this.rmConfig.hasPath(ROOT_POOL_QUEUE_SELECTION_POLICY_KEY) ?
          this.rmConfig.getString(ROOT_POOL_QUEUE_SELECTION_POLICY_KEY) : ROOT_POOL_DEFAULT_QUEUE_SELECTION_POLICY);
  ...
  public String toString() {
    ...
    sb.append(", SelectionPolicy: ").append(selectionPolicy.getSelectionPolicyName());
