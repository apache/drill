...
public class MockLateralJoinPOP extends AbstractStore {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(MockLateralJoinPOP.class);

  @JsonCreator
  public MockLateralJoinPOP(@JsonProperty("child") PhysicalOperator child) {
    super(child);
  }
  ...
  public Store getSpecificStore(PhysicalOperator child, int minorFragmentId) {
    return new MockLateralJoinPOP(child);
  }
