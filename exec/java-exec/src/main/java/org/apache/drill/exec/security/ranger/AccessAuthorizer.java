 ...
 * reflectively via {@link AccessAuthorizerFactory} based on configuration.</p>
 *
 * <p>Access types are identified by string constants defined in
 * {@link AccessTypes} (e.g. {@link AccessTypes#SELECT}, {@link AccessTypes#INSERT}).
 * Callers pass the constant to {@link #checkTableAccess} or
 * {@link #checkColumnAccess}. This avoids a dedicated method per access type
 * and keeps the interface stable as new operations are added.</p>
 */
public interface AccessAuthorizer {
   ...
   *                   {@link AccessTypes#CREATE}, {@link AccessTypes#INSERT})
