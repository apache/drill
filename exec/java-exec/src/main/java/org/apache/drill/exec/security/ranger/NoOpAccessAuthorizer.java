...
/**
 * No-op implementation that allows all access. Used when Ranger authorization
 * is disabled or when the configured implementation fails to initialize.
 */
public class NoOpAccessAuthorizer implements AccessAuthorizer {
  @Override
