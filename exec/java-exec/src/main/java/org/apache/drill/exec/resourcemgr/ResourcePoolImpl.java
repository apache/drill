...
public class ResourcePoolImpl implements ResourcePool {
   ...
   * @return - true - if given query is selected by this ResourcePool otherwise false
   */
  @Override
   ...
   * @throws RMConfigException - In cases of bad configuration
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append(", Selector: ").append(assignedSelector.getSelectorType().getTypeName());
    if (isLeafPool()) {
