...
public class AccessAuthorizerFactory {
  ...
  private static AccessAuthorizer createAuthorizer(DrillConfig config) {
    ...
    try {
      ...
      logger.error("Failed to initialize Ranger authorizer {}, falling back to fail-closed", impl, e);
      throw new RuntimeException("Failed to initialize Ranger authorizer impl:" + impl
