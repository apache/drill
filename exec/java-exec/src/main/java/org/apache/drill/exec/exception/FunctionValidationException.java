...
public class FunctionValidationException extends DrillRuntimeException {
  ...
  public FunctionValidationException() {
    super();
  }
  ...
  public FunctionValidationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
