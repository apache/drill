...
public final class ExecConstants {
  ...
  public static final OptionValidator PARQUET_WRITER_COMPRESSION_TYPE_VALIDATOR = new EnumeratedStringValidator(
      ...
      "Compression type for storing Parquet output. Allowed values: snappy (default), gzip, none.",
      "snappy", "gzip", "none");
  ...
  public static final OptionValidator PARQUET_RECORD_READER_IMPLEMENTATION_VALIDATOR = new BooleanValidator(
      ...
      "Enables the text reader that complies with the RFC 4180 standard for text/csv files.");

  public static final OptionValidator COMPILE_SCALAR_REPLACEMENT = new BooleanValidator(
  ...
  public static final BooleanValidator JSON_READER_ALL_TEXT_MODE_VALIDATOR = new BooleanValidator(JSON_ALL_TEXT_MODE,
      false, "Drill reads all data from the JSON files as VARCHAR. Prevents schema change errors.");
  public static final BooleanValidator JSON_EXTENDED_TYPES = new BooleanValidator("store.json.extended_types", false,
      "Turns on special JSON structures that Drill serializes for storing more type information than the four basic" +
          " JSON types.");
  public static final BooleanValidator JSON_WRITER_UGLIFY = new BooleanValidator("store.json.writer.uglify", false);
  public static final BooleanValidator JSON_WRITER_SKIPNULLFIELDS = new BooleanValidator(
  ...
  public static final OptionValidator FILESYSTEM_PARTITION_COLUMN_LABEL_VALIDATOR = new StringValidator(
      FILESYSTEM_PARTITION_COLUMN_LABEL, "dir",
      "The column label for directory levels in results of queries of files in a directory. Accepts a string input.");
  ...
  public static final OptionValidator IMPLICIT_FILENAME_COLUMN_LABEL_VALIDATOR = new StringValidator(
  ...
  public static final OptionValidator IMPLICIT_SUFFIX_COLUMN_LABEL_VALIDATOR = new StringValidator(
  ...
  public static final OptionValidator IMPLICIT_FQN_COLUMN_LABEL_VALIDATOR = new StringValidator(
  ...
  public static final OptionValidator IMPLICIT_FILEPATH_COLUMN_LABEL_VALIDATOR = new StringValidator(
  ...
  public static final BooleanValidator JSON_READ_NUMBERS_AS_DOUBLE_VALIDATOR = new BooleanValidator(
      ...
      "Reads numbers with or without a decimal point as DOUBLE. Prevents schema change errors.");
  ...
  public static final OptionValidator MONGO_READER_READ_NUMBERS_AS_DOUBLE_VALIDATOR = new BooleanValidator(
  ...
  public static final OptionValidator MONGO_BSON_RECORD_READER_VALIDATOR = new BooleanValidator(
      MONGO_BSON_RECORD_READER, true);

  public static final BooleanValidator ENABLE_UNION_TYPE = new BooleanValidator("exec.enable_union_type", false);
  ...
  public static final String SLICE_TARGET_DESCRIPTION =
      "The number of records manipulated within a fragment before Drill parallelizes operations.";
  public static final long SLICE_TARGET_DEFAULT = 100000L;
  public static final PositiveLongValidator SLICE_TARGET_OPTION = new PositiveLongValidator(SLICE_TARGET,
  ...
  public static final OptionValidator CAST_TO_NULLABLE_NUMERIC_OPTION = new BooleanValidator(CAST_TO_NULLABLE_NUMERIC,
      false, "In a text file, treat empty fields as NULL values instead of empty string.");

  /**
   * HashTable runtime settings
   */
  public static final String MIN_HASH_TABLE_SIZE_KEY = "exec.min_hash_table_size";
  public static final PositiveLongValidator MIN_HASH_TABLE_SIZE = new PositiveLongValidator(MIN_HASH_TABLE_SIZE_KEY,
      HashTable.MAXIMUM_CAPACITY, HashTable.DEFAULT_INITIAL_CAPACITY,
      "Starting size in bucketsfor hash tables. Increase according to available memory to improve performance." +
          " Increasing for very large aggregations or joins when you have large amounts of memory for Drill to" +
          " use. Range: 0 - " + HashTable.MAXIMUM_CAPACITY);
  public static final String MAX_HASH_TABLE_SIZE_KEY = "exec.max_hash_table_size";
  public static final PositiveLongValidator MAX_HASH_TABLE_SIZE = new PositiveLongValidator(MAX_HASH_TABLE_SIZE_KEY,
  ...
  public static final OptionValidator MAX_WIDTH_PER_NODE = new PositiveLongValidator(MAX_WIDTH_PER_NODE_KEY,
      Integer.MAX_VALUE, (long) Math.ceil(Runtime.getRuntime().availableProcessors() * 0.70),
      "Maximum number of threads that can run in parallel for a query on a node. A slice is an individual thread. " +
          "This number indicates the maximum number of slices per query for the query’s major fragment on a node");
  ...
  public static final OptionValidator MAX_WIDTH_GLOBAL = new PositiveLongValidator(MAX_WIDTH_GLOBAL_KEY,
      Integer.MAX_VALUE, 1000,
      "Same as max per node but applies to the query as executed by the entire cluster. For example, this value might" +
  ...
  public static final OptionValidator AFFINITY_FACTOR = new DoubleValidator(AFFINITY_FACTOR_KEY, 1.2d,
      "Factor by which a node with endpoint affinity is favored while creating assignment." +
          " Accepts inputs of type DOUBLE.");

  public static final String EARLY_LIMIT0_OPT_KEY = "planner.enable_limit0_optimization";
  public static final BooleanValidator EARLY_LIMIT0_OPT = new BooleanValidator(EARLY_LIMIT0_OPT_KEY, false);
  ...
  public static final LongValidator MAX_QUERY_MEMORY_PER_NODE = new RangeLongValidator(
      ...
      "Sets the maximum amount of direct memory allocated to the sort operator in each query on a node. If a query" +
          " plan contains multiple sort operators, they all share this memory. If you encounter memory issues when" +
          " running queries with sort operators, increase the value of this option.");
  ...
  public static final LongValidator LARGE_QUEUE_SIZE = new PositiveLongValidator("exec.queue.large", 1000, 10,
      "Sets the number of large queries that can run concurrently in the cluster. Range: 0 - 1000.");
  public static final LongValidator SMALL_QUEUE_SIZE = new PositiveLongValidator("exec.queue.small", 100000, 100,
      "Sets the number of small queries that can run concurrently in the cluster. Range: 0 - 100000.");
  public static final LongValidator QUEUE_THRESHOLD_SIZE = new PositiveLongValidator("exec.queue.threshold",
      Long.MAX_VALUE, 30000000, "Sets the cost threshold, which depends on the complexity of the queries in" +
      " queue, for determining whether query is large or small. Complex queries have higher thresholds." +
      " Range: 0 - 9223372036854775807.");
  public static final LongValidator QUEUE_TIMEOUT = new PositiveLongValidator("exec.queue.timeout_millis",
      Long.MAX_VALUE, 60 * 1000 * 5, "Indicates how long a query can wait in queue before the query fails." +
      " Range: 0 - 9223372036854775807.");
  ...
  public static final OptionValidator NEW_VIEW_DEFAULT_PERMS_VALIDATOR = new StringValidator(
      NEW_VIEW_DEFAULT_PERMS_KEY, "700", "Sets view permissions using an octal code in the Unix tradition.");

  public static final String CTAS_PARTITIONING_HASH_DISTRIBUTE = "store.partition.hash_distribute";
  public static final BooleanValidator CTAS_PARTITIONING_HASH_DISTRIBUTE_VALIDATOR = new BooleanValidator(
  ...
  public static final BooleanValidator ENABLE_BULK_LOAD_TABLE_LIST = new BooleanValidator(
  ...
  public static final StringValidator ADMIN_USER_GROUPS_VALIDATOR = new AdminOptionValidator(ADMIN_USER_GROUPS_KEY, "");

  /**
   * Option whose value is a public static final String representing list of inbound impersonation policies.
   *
  ...
  public static final OptionValidator WEB_LOGS_MAX_LINES_VALIDATOR = new PositiveLongValidator(
  ...
  public static final LongValidator CODE_GEN_EXP_IN_METHOD_SIZE_VALIDATOR = new LongValidator(
