...
public static class ${type.inputType}${aggrtype.className} implements DrillAggFunc{
  ...
  public void add() {
    ...
    long valueMS = (long) value.months * org.apache.drill.exec.expr.fn.impl.DateUtility.monthToStandardDays +
                          value.days * (org.apache.drill.exec.expr.fn.impl.DateUtility.daysToStandardMillis) +
                          value.milliSeconds;
    long inMS = (long) in.months * org.apache.drill.exec.expr.fn.impl.DateUtility.monthToStandardDays +
    ...
    <#elseif type.outputType == "IntervalDay">
    long valueMS = (long) value.days * (org.apache.drill.exec.expr.fn.impl.DateUtility.daysToStandardMillis) +
                          value.milliSeconds;
