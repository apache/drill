    ...
    new NonStrictExpectations() {
      {
        ...
        context.getOptions();
        result = queryOptions;
        context.getOption(ExecConstants.MAX_HASH_TABLE_SIZE_KEY);
        result = OptionValue.createLong(null, null, HashTable.MAXIMUM_CAPACITY, OptionValue.OptionScope.SESSION);
        context.getConfig();
        result = config;
