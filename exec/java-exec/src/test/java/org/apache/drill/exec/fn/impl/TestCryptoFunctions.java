...
public class TestCryptoFunctions extends BaseTestQuery {
    ...
    public void testMD5() throws Exception {
        final String query = "select md5( 'testing' ) as md5_hash from (values(1))";
        testBuilder()
            .sqlQuery(query)
            .ordered()
    ...
    public void testSHA1() throws Exception {
        final String query = "select sha( 'testing' ) as sha_hash from (values(1))";
        testBuilder()
            .sqlQuery(query)
            .ordered()
            .baselineColumns("sha_hash")
    ...
    public void testSHA384() throws Exception {
        final String query = "select sha384( 'testing' ) as sha_hash from (values(1))";
        testBuilder()
            .sqlQuery(query)
            .ordered()
            .baselineColumns("sha_hash")
    ...
    public void testSHA512() throws Exception {
        final String query = "select sha512( 'testing' ) as sha_hash from (values(1))";
        testBuilder()
            .sqlQuery(query)
            .ordered()
            .baselineColumns("sha_hash")
    ...
    @Test
    public void testAES_Encrypt() throws Exception {
    ...
    @Test
    public void testAES_Decrypt() throws Exception {
