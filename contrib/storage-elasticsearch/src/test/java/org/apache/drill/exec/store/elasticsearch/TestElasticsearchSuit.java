...
public class TestElasticsearchSuit extends BaseTest {
  ...
  public static void initElasticsearch() {
    synchronized (TestElasticsearchSuit.class) {
      if (initCount.get() == 0) {
        startElasticsearch();
      }
  ...
  private static void startElasticsearch() {
    ...
    TestElasticsearchSuit.elasticsearch = new ElasticsearchContainer(imageName)
      .withStartupTimeout(Duration.ofMinutes(2));
    TestElasticsearchSuit.elasticsearch.start();
  }
