...
class FragmentHandle :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_ExecutionProtos_2eproto);
    return ::descriptor_table_ExecutionProtos_2eproto.file_level_metadata[kIndexInFileMessages];
  }
