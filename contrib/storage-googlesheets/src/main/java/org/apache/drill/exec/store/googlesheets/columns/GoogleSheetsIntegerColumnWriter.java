...
public class GoogleSheetsIntegerColumnWriter extends GoogleSheetsColumnWriter {

  private static final Logger logger = LoggerFactory.getLogger(GoogleSheetsIntegerColumnWriter.class);
