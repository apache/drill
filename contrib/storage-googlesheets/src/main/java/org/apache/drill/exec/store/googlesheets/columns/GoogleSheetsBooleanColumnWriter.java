...
public class GoogleSheetsBooleanColumnWriter extends GoogleSheetsColumnWriter {

  private static final Logger logger = LoggerFactory.getLogger(GoogleSheetsBooleanColumnWriter.class);
