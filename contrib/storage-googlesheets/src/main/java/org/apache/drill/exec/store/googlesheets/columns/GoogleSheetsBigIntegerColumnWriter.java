...
public class GoogleSheetsBigIntegerColumnWriter extends GoogleSheetsColumnWriter {

  private static final Logger logger = LoggerFactory.getLogger(GoogleSheetsBigIntegerColumnWriter.class);
