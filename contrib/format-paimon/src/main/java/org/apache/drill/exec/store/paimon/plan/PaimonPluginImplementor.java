...
public class PaimonPluginImplementor extends AbstractPluginImplementor {
  ...
  public boolean canImplement(Filter filter) {
    ...
    try {
      Table table = PaimonTableUtils.loadTable(paimonGroupScan.getFormatPlugin(), paimonGroupScan.getPath());
      RowType rowType = table.rowType();
      return DrillExprToPaimonTranslator.translate(logicalExpression, rowType) != null;
    } catch (IOException e) {
      return false;
    }
  }
