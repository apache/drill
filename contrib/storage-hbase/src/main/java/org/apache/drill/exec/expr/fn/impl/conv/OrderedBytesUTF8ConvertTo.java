...
@FunctionTemplate(name = "convert_toUTF8_OB", scope = FunctionScope.SIMPLE, nulls = NullHandling.NULL_IF_NULL)
public class OrderedBytesUTF8ConvertTo implements DrillSimpleFunc {
