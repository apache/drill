...
// jccote, THIS IS NOT TESTED, I'VE ONLY IMPLEMENTED THE READING MSGPACK
public class MsgpackRecordWriter extends JSONOutputRecordWriter implements RecordWriter {

  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(MsgpackRecordWriter.class);
  ...
  public MsgpackRecordWriter(StorageStrategy storageStrategy) {
  ...
  public void init(Map<String, String> writerOptions) throws IOException {
    ...
    try {
      ...
      // since empty output file will be overwritten (some file systems may
      // restrict
      // append option)
      ...
      JsonGenerator generator = factory.createGenerator(stream).useDefaultPrettyPrinter().configure(
          JsonGenerator.Feature.QUOTE_NON_NUMERIC_NUMBERS, !Boolean.parseBoolean(writerOptions.get("enableNanInf")));
      if (uglify) {
  ...
  public class MapJsonConverter extends FieldConverter {
    ...
    public MapJsonConverter(int fieldId, String fieldName, FieldReader reader) {
      ...
      for (String name : reader) {
        FieldConverter converter = EventBasedRecordWriter.getConverter(MsgpackRecordWriter.this, i++, name,
            reader.reader(name));
  ...
  public class RepeatedListJsonConverter extends FieldConverter {
    ...
    public RepeatedListJsonConverter(int fieldId, String fieldName, FieldReader reader) {
      super(fieldId, fieldName, reader);
      converter = EventBasedRecordWriter.getConverter(MsgpackRecordWriter.this, fieldId, fieldName, reader.reader());
    }
  ...
  public void abort() throws IOException {
    if (cleanUpLocation != null) {
      ...
      logger.info("Aborting writer. Location [{}] on file system [{}] is deleted.", cleanUpLocation.toUri().getPath(),
          fs.getUri());
    }
  }
