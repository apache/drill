...
public class TestMsaccessReader extends ClusterTest {
    ...
    public static void setup() throws Exception {
      ...
      MsaccessFormatConfig formatConfig = new MsaccessFormatConfig(Lists.newArrayList("accdb"));
      cluster.defineFormat("cp", "accdb", formatConfig);

      // Needed for compressed file unit test
     // dirTestWatcher.copyResourceToRoot(Paths.get("accdb/"));
    }
  @Test
  public void testExplicitQuery() throws Exception {
    String sql = "SELECT * FROM cp.`HikeApp (1).accdb`";
