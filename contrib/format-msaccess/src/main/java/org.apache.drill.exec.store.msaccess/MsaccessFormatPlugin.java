...
public class MsaccessFormatPlugin extends EasyFormatPlugin<MsaccessFormatConfig> {
  ...
  private static class MsaccessReaderFactory extends FileReaderFactory {
    ...
    public MsaccessReaderFactory(int maxRecords) {
      this.maxRecords = maxRecords;
    }

    @Override
    public ManagedReader<? extends FileSchemaNegotiator> newReader() {
      return new MsaccessBatchReader(maxRecords);
    }
  }
  ...
  private static EasyFormatPlugin.EasyFormatConfig easyConfig(Configuration fsConf, MsaccessFormatConfig pluginConfig) {
    return EasyFormatPlugin.EasyFormatConfig.builder()
      .readable(true)
      .writable(false)
  ...
  public ManagedReader<? extends FileSchemaNegotiator> newBatchReader(
    ...
    return new MsaccessBatchReader(scan.getMaxRecords());
  }

  @Override
  protected FileScanBuilder frameworkBuilder(OptionManager options, EasySubScan scan) {
    FileScanBuilder builder = new FileScanBuilder();
    builder.setReaderFactory(new MsaccessReaderFactory(scan.getMaxRecords()));
