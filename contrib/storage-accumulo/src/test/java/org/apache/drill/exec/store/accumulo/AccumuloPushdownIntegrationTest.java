...
public class AccumuloPushdownIntegrationTest extends BaseAccumuloTest {
  ...
  public void testFilterOnColumnValue() throws Exception {
    ...
    String sql = "SELECT * FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_USERS) +
        " WHERE employment.company = 'Acme Corp'";
  ...
  public void testProjectionSingleColumn() throws Exception {
    String sql = "SELECT cf.name FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_1);
    runAccumuloSQLVerifyCount(sql, 10);
  }

  @Test
  public void testProjectionMultipleColumns() throws Exception {
    String sql = "SELECT cf.name, cf.city FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_1);
    runAccumuloSQLVerifyCount(sql, 10);
  }

  @Test
  public void testProjectionWithRowKey() throws Exception {
    String sql = "SELECT row_key, personal.first_name FROM " +
        fullTableName(AccumuloTestUtils.TEST_TABLE_USERS);
    runAccumuloSQLVerifyCount(sql, 20);
  }

  @Test
  public void testProjectionSingleColumnFamily() throws Exception {
    String sql = "SELECT personal FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_USERS);
    runAccumuloSQLVerifyCount(sql, 20);
  }
  ...
  public void testLimitSmall() throws Exception {
    String sql = "SELECT * FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_1) + " LIMIT 5";
    runAccumuloSQLVerifyCount(sql, 5);
  }

  @Test
  public void testLimitOnLargeTable() throws Exception {
    String sql = "SELECT * FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_LARGE) + " LIMIT 50";
    runAccumuloSQLVerifyCount(sql, 50);
  }

  @Test
  public void testLimitOne() throws Exception {
    String sql = "SELECT * FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_1) + " LIMIT 1";
    runAccumuloSQLVerifyCount(sql, 1);
  }
  ...
  public void testLimitLargerThanTable() throws Exception {
    ...
    String sql = "SELECT * FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_1) + " LIMIT 100";
    runAccumuloSQLVerifyCount(sql, 10);
  }
  ...
  public void testFilterAndProjection() throws Exception {
    String sql = "SELECT row_key, cf.name FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_1) +
        " WHERE row_key > 'row_005'";
    runAccumuloSQLVerifyCount(sql, 5);
  }
  ...
  public void testFilterProjectionAndLimit() throws Exception {
    String sql = "SELECT row_key, cf.name, cf.city FROM " +
        fullTableName(AccumuloTestUtils.TEST_TABLE_1) +
  ...
  public void testLimitZero() throws Exception {
    String sql = "SELECT * FROM " + fullTableName(AccumuloTestUtils.TEST_TABLE_1) + " LIMIT 0";
    runAccumuloSQLVerifyCount(sql, 0);
  }
}
