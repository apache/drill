...
public final class UserBitShared {
  ...
  public interface OperatorProfileOrBuilder extends
    ...
    /**
     * <code>optional int64 max_allocation = 10;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 80: {
              bitField0_ |= 0x00000040;
              maxAllocation_ = input.readInt64();
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    public static final int MAX_ALLOCATION_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000040) == 0x00000040)) {
        output.writeInt64(10, maxAllocation_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000040) == 0x00000040)) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt64Size(10, maxAllocation_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && (hasMaxAllocation() == other.hasMaxAllocation());
      if (hasMaxAllocation()) {
        result = result && (getMaxAllocation()
            == other.getMaxAllocation());
      }
      result = result && unknownFields.equals(other.unknownFields);
      return result;
    }
  ...
  static {
    ...
    internal_static_exec_shared_OperatorProfile_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_exec_shared_OperatorProfile_descriptor,
        new java.lang.String[] { "InputProfile", "OperatorId", "OperatorType", "SetupNanos", "ProcessNanos", "PeakLocalMemoryAllocated", "Metric", "WaitNanos", "MaxAllocation", });
    internal_static_exec_shared_StreamProfile_descriptor =
