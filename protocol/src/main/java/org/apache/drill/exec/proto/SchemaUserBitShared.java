...
public final class SchemaUserBitShared
{
    ...
    {
        public static final org.apache.drill.exec.proto.SchemaUserBitShared.Func.MessageSchema WRITE =
            new org.apache.drill.exec.proto.SchemaUserBitShared.Func.MessageSchema();
        public static final org.apache.drill.exec.proto.SchemaUserBitShared.Func.BuilderSchema MERGE =
            new org.apache.drill.exec.proto.SchemaUserBitShared.Func.BuilderSchema();
        
        public static class MessageSchema implements com.dyuproject.protostuff.Schema<org.apache.drill.exec.proto.UserBitShared.Func>
        {
            public void writeTo(com.dyuproject.protostuff.Output output, org.apache.drill.exec.proto.UserBitShared.Func message) throws java.io.IOException
            {
                if(message.hasName())
                    output.writeString(1, message.getName(), false);
                for(org.apache.drill.common.types.TypeProtos.MajorType majorType : message.getMajorTypeList())
                    output.writeObject(2, majorType, org.apache.drill.common.types.SchemaTypeProtos.MajorType.WRITE, true);

            }
            public boolean isInitialized(org.apache.drill.exec.proto.UserBitShared.Func message)
            {
                return message.isInitialized();
            }
            public java.lang.String getFieldName(int number)
            {
                return org.apache.drill.exec.proto.SchemaUserBitShared.Func.getFieldName(number);
            }
            public int getFieldNumber(java.lang.String name)
            {
                return org.apache.drill.exec.proto.SchemaUserBitShared.Func.getFieldNumber(name);
            }
            public java.lang.Class<org.apache.drill.exec.proto.UserBitShared.Func> typeClass()
            {
                return org.apache.drill.exec.proto.UserBitShared.Func.class;
            }
            public java.lang.String messageName()
            {
                return org.apache.drill.exec.proto.UserBitShared.Func.class.getSimpleName();
            }
            public java.lang.String messageFullName()
            {
                return org.apache.drill.exec.proto.UserBitShared.Func.class.getName();
            }
            //unused
            public void mergeFrom(com.dyuproject.protostuff.Input input, org.apache.drill.exec.proto.UserBitShared.Func message) throws java.io.IOException {}
            public org.apache.drill.exec.proto.UserBitShared.Func newMessage() { return null; }
        }
        public static class BuilderSchema implements com.dyuproject.protostuff.Schema<org.apache.drill.exec.proto.UserBitShared.Func.Builder>
        {
            public void mergeFrom(com.dyuproject.protostuff.Input input, org.apache.drill.exec.proto.UserBitShared.Func.Builder builder) throws java.io.IOException
            {
                for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
                {
                    switch(number)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            builder.addMajorType(input.mergeObject(org.apache.drill.common.types.TypeProtos.MajorType.newBuilder(), org.apache.drill.common.types.SchemaTypeProtos.MajorType.MERGE));
            ...
            public boolean isInitialized(org.apache.drill.exec.proto.UserBitShared.Func.Builder builder)
            {
                return builder.isInitialized();
            }
            public org.apache.drill.exec.proto.UserBitShared.Func.Builder newMessage()
            {
                return org.apache.drill.exec.proto.UserBitShared.Func.newBuilder();
            }
            public java.lang.String getFieldName(int number)
            {
                return org.apache.drill.exec.proto.SchemaUserBitShared.Func.getFieldName(number);
            ...
            public java.lang.Class<org.apache.drill.exec.proto.UserBitShared.Func.Builder> typeClass()
            {
                return org.apache.drill.exec.proto.UserBitShared.Func.Builder.class;
            }
            public java.lang.String messageName()
            {
                return org.apache.drill.exec.proto.UserBitShared.Func.class.getSimpleName();
            ...
            //unused
            public void writeTo(com.dyuproject.protostuff.Output output, org.apache.drill.exec.proto.UserBitShared.Func.Builder builder) throws java.io.IOException {}
        }
        public static java.lang.String getFieldName(int number)
        {
            switch(number)
    ...
    public static final class Jar
    {
        ...
        public static class MessageSchema implements com.dyuproject.protostuff.Schema<org.apache.drill.exec.proto.UserBitShared.Jar>
        {
            public void writeTo(com.dyuproject.protostuff.Output output, org.apache.drill.exec.proto.UserBitShared.Jar message) throws java.io.IOException
            {
                if(message.hasName())
                    output.writeString(1, message.getName(), false);
                for(org.apache.drill.exec.proto.UserBitShared.Func function : message.getFunctionList())
                    output.writeObject(2, function, org.apache.drill.exec.proto.SchemaUserBitShared.Func.WRITE, true);
                ...
                for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
                {
                    switch(number)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            builder.addFunction(input.mergeObject(org.apache.drill.exec.proto.UserBitShared.Func.newBuilder(), org.apache.drill.exec.proto.SchemaUserBitShared.Func.MERGE));
